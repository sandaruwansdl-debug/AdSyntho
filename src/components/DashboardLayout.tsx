...
const navigation = [
  ...
  { name: 'Campaigns', href: '/campaigns', icon: DocumentTextIcon, current: false },
  { name: 'AI Insights', href: '/insights', icon: LightBulbIcon, current: false },
  { name: 'Accounts', href: '/connect-accounts', icon: UserGroupIcon, current: false },
